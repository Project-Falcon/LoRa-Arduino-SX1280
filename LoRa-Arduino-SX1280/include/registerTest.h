...
// SCK pin 13, MISO(SDO) pin 12, and MOSI(SDI) pin 11.
...
void RegisterTest::readRegisters(uint16_t address, uint8_t *buffer, uint16_t size)
{
    uint16_t index;
...
uint8_t RegisterTest::readRegister(uint16_t address)
{
    uint8_t data;
...
void RegisterTest::writeRegisters(uint16_t address, uint8_t *buffer, uint16_t size)
{
    uint8_t addr_l, addr_h;
    uint8_t i;
...
void RegisterTest::writeRegister(uint16_t address, uint8_t value)
{
    writeRegisters(address, &value, 1);
}

uint32_t RegisterTest::getFreqInt()
{
...
void RegisterTest::printRegisters(uint16_t Start, uint16_t End)
{
...
void RegisterTest::setRfFrequency(uint32_t frequency, int32_t offset)
{
...
bool RegisterTest::begin(int8_t pinNSS, int8_t pinNRESET, int8_t pinRFBUSY, int8_t pinDIO1, int8_t pinDIO2, int8_t pinDIO3, uint8_t device)
{
    saveddevice = device;
...
void RegisterTest::writeCommand(uint8_t Opcode, uint8_t *buffer, uint16_t size)
{
    uint8_t index;
    checkBusy();
...
void RegisterTest::setPacketType(uint8_t packettype)
{
